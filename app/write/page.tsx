    ...
    <div className="min-h-screen bg-[#f7f4ef] font-['Noto_Serif_SC','Source_Han_Serif_SC',serif] text-[#3d3d3d] leading-[1.8]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm mb-2">摘要（可选，不填则自动截取正文）</label>
            <textarea
              value={summary}
          ...
          <div className="flex justify-end gap-4">
            <Link
              href="/"
              className="px-6 py-2 border border-[#e8e4dc] text-[#6b6b6b] rounded-lg hover:bg-[#f0ece4] transition-colors text-sm"
            >
              取消
            </Link>
            <button
